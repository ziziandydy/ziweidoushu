 ...
 */
function createError(errorCode, customMessage = null, additionalData = {}) {
 ...
 */
function sendError(res, errorCode, customMessage = null, additionalData = {}) {
  const errorDef = ErrorCodes[errorCode] || ErrorCodes.INTERNAL_ERROR;
  const errorResponse = createError(errorCode, customMessage, additionalData);
